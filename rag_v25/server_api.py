# server_api.py — v25 FastAPI 앱 팩토리
...
app = FastAPI(
    title="RAG API v25",
    description="Multi-Hop Reasoning (Agentic RAG) · Self-RAG (Self-Correction) · Config 분리 · Service Layer",
    version="25.0.0",
)
...
async def root():
    return {
        ...
        "docs":     "/docs",
        "health":   "/health",
        "features": ["Multi-Hop Reasoning", "Self-RAG", "Config 분리", "Service Layer", "LLM Compression"],
    }
