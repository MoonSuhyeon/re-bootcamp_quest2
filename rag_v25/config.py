...
LOG_FILE             = os.path.join(_BASE, "rag_eval_logs_v25.json")
EMBED_CACHE_FILE     = os.path.join(_BASE, "embed_cache_v25.pkl")
ANSWER_CACHE_FILE    = os.path.join(_BASE, "answer_cache_v25.json")
FAILURE_DATASET_FILE = os.path.join(_BASE, "failure_dataset_v25.json")
USERS_FILE           = os.path.join(_BASE, "rag_users_v25.json")
USAGE_LOG_FILE       = os.path.join(_BASE, "rag_usage_v25.json")
