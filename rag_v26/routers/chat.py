# routers/chat.py — RAG 채팅 엔드포인트  [v26: streaming + RAGAS 로그 추가]
...
async def chat_stream(
    ...
    """
    [NEW v26] 스트리밍 RAG 응답 (SSE).
    검색 → 스트리밍 생성 → RAGAS 로그 저장 순서로 실행.

    SSE 이벤트 형식:
      data: {"type": "token",  "content": "..."}\n\n
      data: {"type": "done",   "trace_id": "...", "latency_ms": 123, "sources": [...]}\n\n
    """
    username = current_user["username"]
