...
LOG_FILE             = os.path.join(_BASE, "rag_eval_logs_v26.json")
EMBED_CACHE_FILE     = os.path.join(_BASE, "embed_cache_v26.pkl")
ANSWER_CACHE_FILE    = os.path.join(_BASE, "answer_cache_v26.json")
FAILURE_DATASET_FILE = os.path.join(_BASE, "failure_dataset_v26.json")
USERS_FILE           = os.path.join(_BASE, "rag_users_v26.json")
USAGE_LOG_FILE       = os.path.join(_BASE, "rag_usage_v26.json")
RAGAS_LOG_FILE       = os.path.join(_BASE, "ragas_log_v26.json")   # [NEW v26]
...
JWT_SECRET_KEY     = os.getenv("JWT_SECRET_KEY", "rag-v26-secret-change-in-production")
JWT_ALGORITHM      = "HS256"
