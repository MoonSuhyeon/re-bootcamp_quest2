# server_api.py — v27 FastAPI 앱 팩토리
...
app = FastAPI(
    title="RAG API v27",
    description="Corrective RAG (CRAG) · Streaming SSE · RAGAS Evaluation · Multi-Hop Reasoning · Self-RAG",
    version="27.0.0",
)
...
async def root():
    return {
        ...
        "docs":     "/docs",
        "health":   "/health",
        "features": ["Corrective RAG (CRAG)", "Streaming SSE", "RAGAS Evaluation", "Multi-Hop Reasoning", "Self-RAG"],
    }
