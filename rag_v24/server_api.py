# server_api.py — v24 FastAPI 앱 팩토리
...
app = FastAPI(
    title="RAG API v24",
    description="Config 분리 · Service Layer 분리 · LLM Compression · ToolRegistry · AsyncRAGEngine",
    version="24.0.0",
)
...
async def root():
    return {
        ...
        "docs":     "/docs",
        "health":   "/health",
        "features": ["Config 분리", "Service Layer", "LLM Compression", "ToolRegistry", "AsyncRAGEngine"],
    }
