...
LOG_FILE             = os.path.join(_BASE, "rag_eval_logs_v24.json")
EMBED_CACHE_FILE     = os.path.join(_BASE, "embed_cache_v24.pkl")
ANSWER_CACHE_FILE    = os.path.join(_BASE, "answer_cache_v24.json")
FAILURE_DATASET_FILE = os.path.join(_BASE, "failure_dataset_v24.json")
USERS_FILE           = os.path.join(_BASE, "rag_users_v24.json")
USAGE_LOG_FILE       = os.path.join(_BASE, "rag_usage_v24.json")
...
JWT_SECRET_KEY     = os.getenv("JWT_SECRET_KEY", "rag-v24-secret-change-in-production")
JWT_ALGORITHM      = "HS256"
